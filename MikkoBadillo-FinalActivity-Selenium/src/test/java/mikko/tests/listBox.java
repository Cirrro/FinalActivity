...
public class listBox extends TestBase{
	...
	public void bootstrapListbox() throws InterruptedException
	{
		...
		//this For loop print twice because of the Items it finds in the listboxTwo have duplicates
		/*
	 	for(WebElement list : listboxTwo)
		{
			String listText = list.getText();
			if(Items.contains(listText))
			{
				System.out.println(listText + "has been moved to the right listbox");
			}
		}
		*/
	...
	public void dataListFilter() throws InterruptedException
	{
		...
		List<WebElement> searched = driver.findElements(By.xpath("//*[contains(text(), '"+data+"')]//parent::div"));
