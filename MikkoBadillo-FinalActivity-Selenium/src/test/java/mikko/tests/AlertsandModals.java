...
public class AlertsandModals extends TestBase{
	...
	public void bootstrapModal() throws InterruptedException
	{
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement modalShow = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='modal-content'])[1]")));
		...
		WebElement modalShow2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='modal-content'])[2]")));
		...
		WebElement modalShow3 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//div[@class='modal-content'])[3]")));
	...
	public void windowPopupModal() throws InterruptedException
	{
	    ...
	    if (iterate.hasNext()) 
	    {
	        ...
	        Assert.assertEquals(twitter, "https://twitter.com/i/flow/login?redirect_after_login=%2Fintent%2Ffollow%3Fscreen_name%3Dseleniumeasy");
